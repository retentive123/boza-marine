<x-layouts.admin title="Edit Showcase Image">
    ...
    <form method="POST" action="{{ route('admin.home-showcase.update', $image) }}" enctype="multipart/form-data" class="mt-6 max-w-2xl rounded-xl border border-navy-100 bg-white p-8">
        @csrf
        @method('PUT')

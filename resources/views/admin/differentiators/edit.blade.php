<x-layouts.admin title="Edit Differentiator">
    ...
    <form method="POST" action="{{ route('admin.differentiators.update', $differentiator) }}" class="mt-6 max-w-2xl rounded-xl border border-navy-100 bg-white p-8">
        @csrf
        @method('PUT')
